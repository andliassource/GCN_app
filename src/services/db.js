...
const INITIAL_DATA = {
  ...
  gerencias: [
    ...
    { id_gerencia: "GER-TIC02", nome: "Gerência Executiva de Governança de TI", sigla: "Geati", tipo: "TIC", id_diretoria: "DIR-001", email: "geati@empresa.com.br", telefone: "(11) 98001-9002", observacao: "Conduz a estratégia de TI. Governa planejamento e conformidade de TIC." },
  ...
  processosCriticos: [
    ...
    { id_processo: "PROC-GER-001", nome: "Assistência Técnica em Campo - Contratos Astec (13 contratos)", descricao: "Gestão de atendimentos técnicos de campo com SLA de 8h (capitais) e 24h (interior).", id_contrato: "CON-ASTEC-01", criticidade: "Alta", id_gerencia: "GER-NEG02", requer_drp: false, ativo_cmdb_id: "", estrategia_drp: "Backup & Restore", sla_contrato_cliente: 0, sla_tic: 0, status_aprovacao_tic: "Pendente" },
    ...
    { id_processo: "PROC-APO-001", nome: "Folha de Pagamento Corporativa (Gepes)", descricao: "[APOIO/DIAFI] Processamento interno de folha. SLA interno: fechamento até dia 25.", id_contrato: "", criticidade: "Alta", id_gerencia: "GER-APO01", sla_interno: "Fechamento da folha até o dia 25 de cada mês. Em crise: processamento emergencial in 48h.", tipo_plano: "PCO-APOIO", requer_drp: false, ativo_cmdb_id: "", estrategia_drp: "Backup & Restore", sla_contrato_cliente: 0, sla_tic: 0, status_aprovacao_tic: "Pendente" },
    { id_processo: "PROC-APO-002", nome: "Liberação de Pagamentos Emergenciais (Gefic)", descricao: "[APOIO/DIAFI] Liberação de pagamentos urgentes em contingências. SLA interno de 4h.", id_contrato: "", criticidade: "Alta", id_gerencia: "GER-APO02", sla_interno: "SLA interno: Liberação de pagamentos em até 4h da solicitação aprovada em crise.", tipo_plano: "PCO-APOIO", requer_drp: false, ativo_cmdb_id: "", estrategia_drp: "Backup & Restore", sla_contrato_cliente: 0, sla_tic: 0, status_aprovacao_tic: "Pendente" },
