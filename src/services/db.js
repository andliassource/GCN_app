...
const INITIAL_DATA = {
  ...
  gerencias: [
    ...
    { id_gerencia: "GER-APO02", nome: "Gerência Executiva de Finanças e Tesouraria", sigla: "Gefic", tipo: "Apoio", id_diretoria: "DIR-003", email: "gefic@empresa.com.br", telefone: "(11) 98001-9009", observacao: "PCO de apoio: SLA de 4h para liberação de pagamentos emergenciais em crises. Sem contrato externo." },
